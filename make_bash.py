...
default_refseq_human = ""
default_refseq_mouse = ""
default_refseq_zebrafish = ""
default_qsub = "yes"
default_qtype = "long"
default_unzip = "no"
default_zip = "no"
...
line15 ="\n\nExample: python make_bash.py -qsub=no -qtype=medium -ref=human -bar=cel-seq_barcodes.csv -bash_out=bash_files -cat_out=cat_files  -map_out=map_files -counts_out=count_files -email=t.hoog@hubrecht.eu"
...
if do_break:		
	sys.exit(break_message + "\nFor help type: python make_bash.py -help\n")
